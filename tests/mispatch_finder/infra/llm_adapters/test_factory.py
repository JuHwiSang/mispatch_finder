...
from mispatch_finder.infra.llm_adapters.factory import get_adapter, run_with_openai, run_with_anthropic
...
def test_get_adapter_openai(monkeypatch):
    ...
    import mispatch_finder.infra.llm_adapters.factory as mod
